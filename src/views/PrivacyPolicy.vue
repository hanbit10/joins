  ...
  <body onload="fillHeaderInitials()">
    <div class="wholeJoinContainer">
      <section class="headerAndOpenedContainer">
        ...
        <section class="privacyPolicyOpenedContainer">
          <div class="privacyPolicyHeadlineAndArrowContainer">
            <h1 class="privacyPolicyHeadline">Privacy Policy</h1>
          ...
          <div class="privacyPolicyTextContainer">
            ...
            <p>
              ...
              <a class="linkAtPrivacyPolicy" href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank"
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Join, accessible from [https://join-187.developerakademie.net/login.html &amp;
                  https://join-187.developerakademie.net](https://join-187.developerakademie.net/login.html &amp;
                  https://join-187.developerakademie.net)
                </p>
              </li>
              <li>
                <p>
            ...
            <ul>
              <li>By email: robingerth21@gmail.com</li>
            </ul>
          </div>
        </section>
